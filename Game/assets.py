...
textures = {
    ...
    "tower_archer_01" : lambda size: load_texture("images/textures/tower_archer_1.jpg", size),
    "tower_archer_02": lambda size: load_texture("images/textures/tower_archer_1.jpg", size),
    "tower_archer_03": lambda size: load_texture("images/textures/tower_archer_1.jpg", size),
    "tower_archer_04": lambda size: load_texture("images/textures/tower_archer_1.jpg", size),
    "tower_archer_05": lambda size: load_texture("images/textures/tower_archer_1.jpg", size),
    "tower_archer_06": lambda size: load_texture("images/textures/tower_archer_1.jpg", size),
}
